...
namespace forte {
  ...
  T func_ABS(const T &paIN) {
    ...
    return (0 > static_cast<typename T::TValueType>(paIN))
               ? T(static_cast<typename T::TValueType>(paIN) * static_cast<typename T::TValueType>(-1))
               : paIN;
  }
  ...
  template<typename T>
  auto func_ROL(const T &paIn, const CIEC_ANY_INT &paN) -> typename mpl::get_equivalent_CIEC_class_t<T> {
    ...
    if ((true == paN.isSigned() && 0 <= paN.getSignedValue()) || false == paN.isSigned()) {
      return returnType(static_cast<typename returnType::TValueType>(
          (paIn << paN.getUnsignedValue()) |
          (paIn >> (sizeof(typename returnType::TValueType) * 8 - paN.getUnsignedValue()))));
    } else {
  ...
  template<typename T>
  auto func_ROR(const T &paIn, const CIEC_ANY_INT &paN) -> typename mpl::get_equivalent_CIEC_class_t<T> {
    static_assert((std::is_base_of_v<CIEC_ANY_BIT, T>), "T not of ANY_BIT");
    using returnType = typename mpl::get_equivalent_CIEC_class_t<T>;
    if ((true == paN.isSigned() && 0 <= paN.getSignedValue()) || false == paN.isSigned()) {
      return returnType(static_cast<typename returnType::TValueType>(
  ...
  template<typename T>
  auto func_SHR(const T &paIn, const CIEC_ANY_INT &paN) -> typename mpl::get_equivalent_CIEC_class_t<T> {
    static_assert((std::is_base_of_v<CIEC_ANY_BIT, T>), "T not of ANY_BIT");
    using returnType = typename mpl::get_equivalent_CIEC_class_t<T>;
    if ((true == paN.isSigned() && 0 <= paN.getSignedValue()) || false == paN.isSigned()) {
      return returnType(static_cast<typename returnType::TValueType>(paIn >> paN.getUnsignedValue()));
  ...
  template<>
  auto func_ROL(const CIEC_BOOL &paIn, const CIEC_ANY_INT &paN) -> CIEC_BOOL;

  template<>
  auto func_ROR(const CIEC_BOOL &paIn, const CIEC_ANY_INT &paN) -> CIEC_BOOL;

  template<>
  auto func_SHL(const CIEC_BOOL &paIn, const CIEC_ANY_INT &paN) -> CIEC_BOOL;

  template<>
  auto func_SHR(const CIEC_BOOL &paIn, const CIEC_ANY_INT &paN) -> CIEC_BOOL;
  ...
  template<typename T, typename U>
  auto func_XOR(const T &paIN1, const U &paIN2) ->
      typename mpl::get_castable_type_t<typename mpl::get_equivalent_CIEC_class_t<T>,
                                        typename mpl::get_equivalent_CIEC_class_t<U>> {
    using tTClass = typename mpl::get_equivalent_CIEC_class_t<T>;
    using tUClass = typename mpl::get_equivalent_CIEC_class_t<U>;
  ...
  CIEC_BOOL func_GT(const T &paIN1, const T &paIN2) {
    if constexpr (forte::mpl::has_greater_v<T>) {
      return CIEC_BOOL(paIN1 > paIN2);
    } else {
  ...
  CIEC_BOOL func_GE(const T &paIN1, const T &paIN2) {
    if constexpr (forte::mpl::has_greater_equal_v<T>) {
      return CIEC_BOOL(paIN1 >= paIN2);
    } else {
      return CIEC_BOOL(static_cast<typename T::TValueType>(paIN1) >= static_cast<typename T::TValueType>(paIN2));
    }
  ...
  CIEC_BOOL func_LT(const T &paIN1, const T &paIN2) {
    if constexpr (forte::mpl::has_less_v<T>) {
      return CIEC_BOOL(paIN1 < paIN2);
    } else {
      return CIEC_BOOL(static_cast<typename T::TValueType>(paIN1) < static_cast<typename T::TValueType>(paIN2));
    }
  ...
  CIEC_BOOL func_NE(const T &paIN1, const T &paIN2) {
    if constexpr (forte::mpl::has_inequality_v<T>) {
      return CIEC_BOOL(paIN1 != paIN2);
    } else {
      return CIEC_BOOL(static_cast<typename T::TValueType>(paIN1) != static_cast<typename T::TValueType>(paIN2));
    }
  ...
  template<typename T, typename U>
  auto func_MAX(const T &paIN1, const U &paIN2) -> typename mpl::get_castable_type_t<T, U> {
  ...
  CIEC_TIME func_MUL_TIME(const CIEC_TIME &paIN1, const T &paIN2) {
    ...
    return CIEC_TIME(static_cast<TimeValueType>(static_cast<MulValueType>(static_cast<TimeValueType>(paIN1)) *
                                                static_cast<In2ValueType>(paIN2)));
  }
  ...
  CIEC_LTIME func_MUL_LTIME(const CIEC_LTIME &paIN1, const T &paIN2) {
    ...
    return CIEC_LTIME(static_cast<LTimeValueType>(static_cast<MulValueType>(static_cast<LTimeValueType>(paIN1)) *
                                                  static_cast<In2ValueType>(paIN2)));
  }
  ...
  template<typename T>
  auto func_TO_LITTLE_ENDIAN(const T &paValue) ->
      typename std::enable_if_t<std::endian::native == std::endian::big && std::is_base_of_v<CIEC_ANY_MAGNITUDE, T>,
                                T> {
    return swapEndianess(paValue);
  }
